#' Plot the \code{cosimmrSTAN_input} data created from \code{cosimmrSTAN_load}
#'
...
#'
#' @param x An object created via the function \code{\link{cosimmrSTAN_load}}
...
#' plot(cosimmrSTAN_3, tracers = c(2, 3))
#' # and finally d13C vs d34S
#' plot(cosimmrSTAN_3, tracers = c(1, 3))
#' }
#' @export
plot.cosimmrSTAN_input <-
  function(x,
           tracers = c(1, 2),
           title = "Tracers plot",
