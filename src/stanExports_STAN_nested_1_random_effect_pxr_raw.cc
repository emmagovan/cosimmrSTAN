...
#include "stanExports_STAN_nested_1_random_effect_pxr_raw.h"

RCPP_MODULE(stan_fit4STAN_nested_1_random_effect_pxr_raw_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_STAN_nested_1_random_effect_pxr_raw")
