...
namespace model_STAN_VB_pxr_raw_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 79> locations_array__ =
  {" (found before start of program)",
  " (in 'STAN_VB_pxr_raw', line 20, column 2 to column 31)",
  " (in 'STAN_VB_pxr_raw', line 21, column 2 to column 20)",
  " (in 'STAN_VB_pxr_raw', line 22, column 3 to column 30)",
  " (in 'STAN_VB_pxr_raw', line 26, column 2 to column 49)",
  " (in 'STAN_VB_pxr_raw', line 27, column 2 to column 17)",
  " (in 'STAN_VB_pxr_raw', line 28, column 2 to column 21)",
  " (in 'STAN_VB_pxr_raw', line 29, column 2 to column 17)",
  " (in 'STAN_VB_pxr_raw', line 32, column 6 to column 47)",
  " (in 'STAN_VB_pxr_raw', line 31, column 19 to line 33, column 5)",
  " (in 'STAN_VB_pxr_raw', line 31, column 4 to line 33, column 5)",
  " (in 'STAN_VB_pxr_raw', line 30, column 17 to line 34, column 3)",
  " (in 'STAN_VB_pxr_raw', line 30, column 2 to line 34, column 3)",
  " (in 'STAN_VB_pxr_raw', line 36, column 4 to column 57)",
  " (in 'STAN_VB_pxr_raw', line 35, column 17 to line 37, column 3)",
  " (in 'STAN_VB_pxr_raw', line 35, column 2 to line 37, column 3)",
  " (in 'STAN_VB_pxr_raw', line 40, column 6 to line 41, column 110)",
  " (in 'STAN_VB_pxr_raw', line 39, column 19 to line 42, column 5)",
  " (in 'STAN_VB_pxr_raw', line 39, column 4 to line 42, column 5)",
  " (in 'STAN_VB_pxr_raw', line 38, column 17 to line 43, column 3)",
  " (in 'STAN_VB_pxr_raw', line 38, column 2 to line 43, column 3)",
  " (in 'STAN_VB_pxr_raw', line 49, column 6 to column 31)",
  " (in 'STAN_VB_pxr_raw', line 48, column 19 to line 50, column 5)",
  " (in 'STAN_VB_pxr_raw', line 48, column 4 to line 50, column 5)",
  " (in 'STAN_VB_pxr_raw', line 47, column 17 to line 51, column 3)",
  " (in 'STAN_VB_pxr_raw', line 47, column 2 to line 51, column 3)",
  " (in 'STAN_VB_pxr_raw', line 53, column 2 to column 45)",
  " (in 'STAN_VB_pxr_raw', line 54, column 2 to column 47)",
  " (in 'STAN_VB_pxr_raw', line 58, column 6 to column 134)",
  " (in 'STAN_VB_pxr_raw', line 59, column 6 to column 48)",
  " (in 'STAN_VB_pxr_raw', line 57, column 19 to line 60, column 5)",
  " (in 'STAN_VB_pxr_raw', line 57, column 4 to line 60, column 5)",
  " (in 'STAN_VB_pxr_raw', line 56, column 17 to line 61, column 3)",
  " (in 'STAN_VB_pxr_raw', line 56, column 2 to line 61, column 3)",
  " (in 'STAN_VB_pxr_raw', line 2, column 2 to column 17)",
  " (in 'STAN_VB_pxr_raw', line 3, column 2 to column 17)",
  " (in 'STAN_VB_pxr_raw', line 4, column 2 to column 17)",
  " (in 'STAN_VB_pxr_raw', line 5, column 2 to column 17)",
  " (in 'STAN_VB_pxr_raw', line 6, column 9 to column 10)",
  " (in 'STAN_VB_pxr_raw', line 6, column 12 to column 13)",
  " (in 'STAN_VB_pxr_raw', line 6, column 2 to column 17)",
  " (in 'STAN_VB_pxr_raw', line 7, column 9 to column 10)",
  " (in 'STAN_VB_pxr_raw', line 7, column 12 to column 13)",
  " (in 'STAN_VB_pxr_raw', line 7, column 2 to column 17)",
  " (in 'STAN_VB_pxr_raw', line 8, column 9 to column 10)",
  " (in 'STAN_VB_pxr_raw', line 8, column 12 to column 13)",
  " (in 'STAN_VB_pxr_raw', line 8, column 2 to column 22)",
  " (in 'STAN_VB_pxr_raw', line 9, column 9 to column 10)",
  " (in 'STAN_VB_pxr_raw', line 9, column 12 to column 13)",
  " (in 'STAN_VB_pxr_raw', line 9, column 2 to column 22)",
  " (in 'STAN_VB_pxr_raw', line 10, column 9 to column 10)",
  " (in 'STAN_VB_pxr_raw', line 10, column 12 to column 13)",
  " (in 'STAN_VB_pxr_raw', line 10, column 2 to column 20)",
  " (in 'STAN_VB_pxr_raw', line 11, column 9 to column 10)",
  " (in 'STAN_VB_pxr_raw', line 11, column 12 to column 13)",
  " (in 'STAN_VB_pxr_raw', line 11, column 2 to column 20)",
  " (in 'STAN_VB_pxr_raw', line 12, column 9 to column 10)",
  " (in 'STAN_VB_pxr_raw', line 12, column 2 to column 24)",
  " (in 'STAN_VB_pxr_raw', line 13, column 9 to column 10)",
  " (in 'STAN_VB_pxr_raw', line 13, column 2 to column 23)",
  " (in 'STAN_VB_pxr_raw', line 14, column 2 to column 25)",
  " (in 'STAN_VB_pxr_raw', line 15, column 9 to column 10)",
  " (in 'STAN_VB_pxr_raw', line 15, column 12 to column 13)",
  " (in 'STAN_VB_pxr_raw', line 15, column 2 to column 17)",
  " (in 'STAN_VB_pxr_raw', line 16, column 9 to column 10)",
  " (in 'STAN_VB_pxr_raw', line 16, column 2 to column 26)",
  " (in 'STAN_VB_pxr_raw', line 17, column 9 to column 10)",
  " (in 'STAN_VB_pxr_raw', line 17, column 2 to column 25)",
  " (in 'STAN_VB_pxr_raw', line 20, column 18 to column 19)",
  " (in 'STAN_VB_pxr_raw', line 21, column 9 to column 10)",
  " (in 'STAN_VB_pxr_raw', line 21, column 12 to column 13)",
  " (in 'STAN_VB_pxr_raw', line 22, column 19 to column 20)",
  " (in 'STAN_VB_pxr_raw', line 26, column 9 to column 10)",
  " (in 'STAN_VB_pxr_raw', line 27, column 9 to column 10)",
  " (in 'STAN_VB_pxr_raw', line 27, column 12 to column 13)",
  " (in 'STAN_VB_pxr_raw', line 28, column 9 to column 10)",
  " (in 'STAN_VB_pxr_raw', line 28, column 12 to column 13)",
  " (in 'STAN_VB_pxr_raw', line 29, column 9 to column 10)",
  " (in 'STAN_VB_pxr_raw', line 29, column 12 to column 13)"};
#include <stan_meta_header.hpp>
class model_STAN_VB_pxr_raw final : public model_base_crtp<model_STAN_VB_pxr_raw> {
private:
  int J;
  int N;
  int K;
...
public:
  ~model_STAN_VB_pxr_raw() {}
  model_STAN_VB_pxr_raw(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_STAN_VB_pxr_raw_namespace::model_STAN_VB_pxr_raw";
    // suppress unused var warning
    (void) function__;
    ...
    num_params_r__ = J + (K * L) + J;
  }
  inline std::string model_name() const final {
    return "model_STAN_VB_pxr_raw";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_STAN_VB_pxr_raw_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_STAN_VB_pxr_raw_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"sigma_raw", "beta", "omicron"};
    if (emit_transformed_parameters__) {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"sigma_raw\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(J) + "},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(K) + ",\"cols\":" + std::to_string(L) + "},\"block\":\"parameters\"},{\"name\":\"omicron\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(J) + "},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(J) + "},\"block\":\"transformed_parameters\"},{\"name\":\"p\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(K) + "},\"block\":\"transformed_parameters\"},{\"name\":\"var_y\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(J) + "},\"block\":\"transformed_parameters\"},{\"name\":\"f\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(K) + "},\"block\":\"transformed_parameters\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = ((J + (K * L)) + J);
...
using stan_model = model_STAN_VB_pxr_raw_namespace::model_STAN_VB_pxr_raw;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_STAN_VB_pxr_raw_namespace::profiles__;
}
#endif
#endif
