...
#include "stanExports_STAN_VB_p+r_raw.h"

RCPP_MODULE(stan_fit4STAN_VB_p+r_raw_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_STAN_VB_p+r_raw")
