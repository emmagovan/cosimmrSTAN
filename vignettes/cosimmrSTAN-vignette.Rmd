...
We can then look at a random effect in Wolves data from Semmens et al 2009 
...
For our second example we will look at Pack as a random effect. We first load in our data using the `cosimmrSTAN_load` function.
```{r}
